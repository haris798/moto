...
export default function SettingsTab({
  ...
  <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 shadow-xs">
        ...
        {tgEnabled && (
          <div className="flex items-center gap-1.5 mr-2">
            <button
              ...
              className="p-2 text-slate-400 hover:text-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 rounded-xl transition-colors disabled:opacity-50"
              title="Tes Notifikasi"
            >
              <Bell className={`w-4.5 h-4.5 ${tgTesting ? 'animate-bounce' : ''}`} />
            </button>
            <button
              ...
              type="submit"
              form="telegram-form"
              className="p-2 text-slate-400 hover:text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 rounded-xl transition-colors"
              title="Simpan Pengaturan"
            >
    ...
    <form id="telegram-form" onSubmit={handleSaveTelegram} className="space-y-4">
